...
public class SearchJiraTest {
  ...
  public void testValidJQL() {
    ...
    searchPage.advancedField("project = QAAUT6 AND text ~ \"Test new issue\" order by createdDate  ASC");
    searchPage.clickSearchButton();
    Assert.assertEquals(searchPage.titleTestNewIssueIsDisplayed(), true);
  }
