...
public class SearchPage {
  ...
  public void clickSubmitFilterName() {
  ...
  public void clickFilterTypeIssue() {
  ...
  public boolean titleTestNewIssueIsDisplayed() {
    return $(By.cssSelector("[title='[Test Automation] Test New Issue']")).waitUntil(Condition.visible, 5000).isDisplayed();
  }

  public void errorMessageTable() {
    $(By.xpath("//div[@class = 'aui-message error']")).isDisplayed();
  }

  public void errorIcon() {
    $(By.id("jqlerrormsg")).isDisplayed();
  }

  public void defaultLabelsStatuses() {
